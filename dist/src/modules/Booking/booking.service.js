...
const createBooking = async (data, user_id) => {
...
const getTeacherBooking = async (userId) => {
...
const getMyBookingById = async (userId, bookingId) => {
...
const updateMyBooking = async (userId, bookingId, bookingStatus) => {
...
const updateTeacherBooking = async (teacherId, bookingId, bookingStatus) => {
